...
def _main():
    ...
    parser.add_argument("--peft-dir", type=str, required="peft_lora_multitask_encoder ")
    parser.add_argument("--model-state", type=str, default="../lora_multitask_best.pth")
    parser.add_argument("--test-csv", type=str, required="./gt_reviews.csv")
